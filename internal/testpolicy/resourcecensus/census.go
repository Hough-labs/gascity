...
var bootstrapPolicy = Ledger{
	...
	AuditBaseline: []Baseline{
		...
		},
		{
			...
			OwnerBead:       "ga-80po0c.2",
			Invariant:       "tracked test source totals remain visible as audit evidence",
			ResourceOwner:   "ga-80po0c.2 owns this point-in-time source census; +1/+1 on 2026-08-18 owned by gascity-4zf (df0f1ad31, TestCollectLiveWorktreeState_ProtectsDirWithLiveProcess)",
			MigrationTarget: "P0.4a",
			Expires:         "2026-10-01",
		},
		{
	...
	Debt: []Baseline{
		...
		},
		{
			...
			ResourceOwner:   "each owning test replaces elapsed wall time with its lifecycle signal; +1/+1 on 2026-08-18 owned by gascity-4zf (df0f1ad31, TestCollectLiveWorktreeState_ProtectsDirWithLiveProcess)",
	...
	SmallDebt: []Baseline{
		...
		},
		{
			...
			ResourceOwner:   "non-Medium lexical owners replace elapsed wall time with lifecycle signals; +1/+1 on 2026-08-18 owned by gascity-4zf (df0f1ad31, TestCollectLiveWorktreeState_ProtectsDirWithLiveProcess)",
			MigrationTarget: "W1-W5",
			Expires:         "2026-10-01",
		},
		{
