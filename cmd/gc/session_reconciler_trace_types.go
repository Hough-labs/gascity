...
const (
	...
	TraceSiteReconcilerPartialRuntimeObservation TraceSiteCode = "reconciler.session.partial_runtime_observation"
...
const (
	...
	TraceReasonPartialRuntimeObservation     TraceReasonCode = "partial_runtime_observation"
